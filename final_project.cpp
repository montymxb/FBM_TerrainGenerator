...
void Display() {
	...
	glEnable(GL_LIGHT7);
	setup_point_light(GL_LIGHT7, 10.0, 100.0, 26.0, 0.1, 0.1, 0.1);

	/* TODO spot light example
	setup_spot_light(
		curLight,
		cars[g].position.x * gridShiftSize + 0.875, cars[g].position.y * gridShiftSize + 0.875, 0.0,
		sin(cars[g].currentDirection * 3.14159 / 180.0f) * 0.2, cos(cars[g].currentDirection * 3.14159 / 180.0f) * -0.2, -0.2,
		1.0, 1.0, 0.0
	);
	*/
